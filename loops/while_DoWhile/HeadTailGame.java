...
public class HeadTailGame {
     ...
     */
        ...
        do{
            ...
            String guess = sc.nextLine();     //users answer Head or Tail
            int number = random.nextInt(2);    //there are only 2 answers
           ...
           if(guess.equalsIgnoreCase(result)) {
               ...
               System.out.println("Sorry, that was not the correct choise!");
           }
        ...
        }while(playAgain.equalsIgnoreCase("yes"));  //if user says "yes"

        System.out.println("Its OK, See you next time!");   //if no
