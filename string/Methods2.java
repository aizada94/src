...
public class Methods2 {
    public static void main(String[] args) {
        ...
        int indexOfR =  flower.indexOf('R');   // " and ' both is fine
        ...
        System.out.println(flower.indexOf("Rose")); //0 the first letter is zero
        System.out.println(flower.indexOf("rose")); //-1 because we didn't have the string like this
